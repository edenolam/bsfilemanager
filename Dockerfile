...
CMD chown bsfm /logs /nas-drive && sleep 5 && su bsfm -s /bin/sh -c "java -jar FileStorageManager-0.0.5-SNAPSHOT.jar"

COPY --from=build /workspace/target/FileStorageManager-0.0.5-SNAPSHOT.jar /workspace
